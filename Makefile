...
integration: gocheck
	CAPE_DB_URL=$(CAPE_DB_URL) CAPE_DB_CUSTOMER_URL=$(CAPE_DB_CUSTOMER_URL) CAPE_DB_SEED_MIGRATIONS=$(CAPE_DB_SEED_MIGRATIONS) CAPE_DB_TEST_MIGRATIONS=$(CAPE_DB_TEST_MIGRATIONS) CAPE_DB_MIGRATIONS=$(CAPE_DB_MIGRATIONS) go test -v ./... -tags=integration
