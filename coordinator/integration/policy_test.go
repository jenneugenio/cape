...
func TestPolicies(t *testing.T) {
	...
	//	gm.Expect(err).To(gm.BeNil())
	//
	//	policy, err := client.CreateDeprecatedPolicy(ctx, p)
	//	gm.Expect(err).To(gm.BeNil())
	//
	...
	//	gm.Expect(err).To(gm.BeNil())
	//
	//	_, err = client.CreateDeprecatedPolicy(ctx, p)
	//	gm.Expect(err).To(gm.BeNil())
	//
	...
	//	gm.Expect(err).To(gm.BeNil())
	//
	//	_, err = client.CreateDeprecatedPolicy(ctx, p1)
	//	gm.Expect(err).To(gm.BeNil())
	//
	//	p2, err := primitives.NewPolicy(label, spec)
	//	gm.Expect(err).To(gm.BeNil())
	//
	//	_, err = client.CreateDeprecatedPolicy(ctx, p2)
