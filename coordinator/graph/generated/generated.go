...
`, BuiltIn: false},
	&ast.Source{Name: "coordinator/schema/schema.graphql", Input: `type AuthCredentials {
  salt: Base64!
...
type Query {
  ...
  sources: [Source!]!
  source(id: ID!): Source!
  sourceByLabel(label: Label!): Source!
...
type Mutation {
  ...
  removeSource(input: RemoveSourceRequest!): String
