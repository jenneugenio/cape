...
type Schema struct {
	...
	Type                 RecordType `protobuf:"varint,3,opt,name=type,proto3,enum=cape.proto.RecordType" json:"type,omitempty"`
...
type Field struct {
	Field                FieldType `protobuf:"varint,1,opt,name=field,proto3,enum=cape.proto.FieldType" json:"field,omitempty"`
...
func init() {
	proto.RegisterEnum("cape.proto.RecordType", RecordType_name, RecordType_value)
	proto.RegisterEnum("cape.proto.FieldType", FieldType_name, FieldType_value)
	proto.RegisterType((*QueryRequest)(nil), "cape.proto.QueryRequest")
	proto.RegisterType((*Record)(nil), "cape.proto.Record")
	proto.RegisterType((*Schema)(nil), "cape.proto.Schema")
...
func (c *dataConnectorClient) Query(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (DataConnector_QueryClient, error) {
	stream, err := c.cc.NewStream(ctx, &_DataConnector_serviceDesc.Streams[0], "/cape.proto.DataConnector/Query", opts...)
	if err != nil {
		return nil, err
	}
